...
But here's the rub: R operates like this. Let me show you. Below is R, not LISP. Again, try this yourself:
...
Which we then put into another code block to make it a bit less ugly. This is what Assembly looks like. This is the kind of thing being swept under the rug when you do 5 + 2 and print it out.
...
Be familiar with the full stack. Whatever it is. And you will be a better problem solver, able to see the high-level, and able to reason from first principles.
