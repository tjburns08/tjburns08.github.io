...
The thing that is missing here is what I like to call the "relevance filter." This is the ability to look at a bunch of stuff and say "...that one." At 39, I have built up a relevance filter for the life sciences that started around 20 years ago when I began taking chemistry and biology classes in undergrad.
...
By the way, my "relevance filter" wording can be attributed to the official term "relevance realization" coined by cognitive scientist and philosopher John Vervaeke. He connects this directly to what wisdom is. So I'm not just blowing wind here.
