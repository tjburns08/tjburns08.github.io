...
#+HTML: <a href="#top">Back to top</a>
The links are to Wikipedia lists of unsolved problems for the given domain. Way too many questions to copy over and list here, so I'll list the ones that are on my mind from each section. My commentary is indeicated, and my questions relevant to the given topic are listed below a line separator.
