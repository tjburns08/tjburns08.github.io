...
* About me
[[./meditations_chapter_one.html][I]] am an American CEO and computational biologist who lives in Berlin, Germany. I am best known for work in the single-cell field (2011, if we count CyTOF), and more recently (2023 and onward), my work in biosecurity. I am informally known for my passion for fitness, which gives me the balance and energy to do the rest of the work.

I run a company called [[./burns_lsc.html][Burns Life Sciences Consulting, GmbH]], which allows me to impact many more individuals and organizations than I otherwise could as an employee. I'm also a biosecurity research lead at [[https://helena.org/team/tyler-burns][Helena]]. A problem I face is most of my work is behind NDAs so I can't talk about it. There is another large amount of my work that is unpublished, simply because running a company has a lot of demands that don't give me the time.
...
Who are my intended readers? The first one is future-me. It's interesting now to read stuff I've written years ago, and see where my head space was. You should do it too. The second are up and coming scientists, bioinformaticians, and entrepreneurs in the life sciences space who want to understand how I think and do things (which I can at least say with confidence is different than most), and perhaps want to collaborate. The third are people who have left the obvious "ladder" and are now faced with a blinding array of choices and no one ahead of them to spell out what to do next. You'll see echoes of this in my writings, and hopefully you'll feel a bit less alone in your unique path. And the final reader is AI. If any ideas here are truly novel, they could full well end up in LLM output or agent decisions down the line.
...
* New
#+HTML: <a href="#top">Back to top</a>
** Podcast: Go With the Flow ([[https://open.spotify.com/episode/0nSIZDDIdbXrd8GoFwTTvl?si=IQp3npEmTbGEGdl5Us7iNg&nd=1&dlsi=6ff0bac686314221][Spotify]]; [[https://www.youtube.com/watch?v=pdlfhU4q3P4][YouTube]])
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Podcast.\\

Here, I chat with Eric Haas and Christian Aguilera-Sandoval about flow and mass cytometry analysis. The topics covered my thesis lab, AI, my company, and a deep dive into dimensionality reduction and especially my [[https://github.com/tjburns08/KnnSleepwalk][KNN Sleepwalk]] project. The podcast itself was unstructured, so you are getting my unedited thoughts on whatever we are talking about.
** [[./old-pond-two-letters.html][Dynamic Poetry]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Html doc.\\
September 10, 2026 - September 26, 2026

An idea I got in the shower. Take a haiku and a given word each round and watch as the meaning of the poem starts to drift. A haiku is good for this because you can hold the whole thing in your working memory, such that every letter changes the felt sense around the poem in real time. You can do other types of mutations, like whole words or one letter. But two letter worked for this one in partcular: Matsuo Bashō’s "The Old Pond." Then there's another level to it. You can control the drift to tell entire stories. I have a few examples of this as well.
** [[./kelly_farm_report.html][Remembering the Kelly Farm]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Article.\\
...
My childhood house was in the middle of Sacramento suburbia. But there was one weird anomaly one street over. A private two acre lot, most of which was hidden. But it was definitely "rural" looking unlike literally everything else nearby. And there were horses. It turns out that this was last remaining farmstead remnant of the Kelly Farm, 200+ acres of farm land dating back to 1882 upon which the entire neighborhood was built in the 1960s-1980s (we got there in 1990). The lot was advertised as a development opportunity and sold in 2015. There is a good chance that it will become houses. Accordingly, because it is not becoming a museum (it should be), this article attempts to preserve the memory of the farm and that little relic, coming from a man who grew up right next to it, not knowing the weight of it until later in life.
** [[./knn_kfn_sweep_10k.html][UMAP KNN to KFN sweep]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Web app.\\
July 5, 2026 - July 6, 2026

Neighborhood preservation is a great benchmarking metric to compare dimensionality reduction tools. Visually, it is a great intuition builder around how well these tools preserve local information. I have shown this with KNN Sleepwalk. Here, I extend the idea by creating a tool that does a "sweep" from the k nearest neighbors (KNN) to the k farthest neighbors (KFN), to show that although UMAP claims to be good at global preservation, the reality is more complicated than that. The intent of this tool is not to knock on UMAP. But rather to dispel as many assumptions about preservation as possible, as quickly as possible.
** [[./website_internal_link_graph.html][Graph visualization of my website]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Visualization.\\
August 5, 2023 - June 10, 2026.

My website functions a bit like a personal wiki, with content linking internally to other content. Here is a graph that shows an updated version of what links to what, so the reader can get a feel for what ideas I express and how they relate to each other. Each node is a page, colored by its topic and sized by the number of links it has. Hover over a node to light up the pages it connects to, and click it to go there.

** [[./game_mode/game_mode.html][Game mode for viewing my website]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
...
Who says that scrolling is the best way to view a website? Here, I developed an interactive "overworld" for browsing my website, in the style of Super Mario World. The overworld is divided into biomes that correspond to the categories of content I work on and share here. Each "level" is a piece of content on my website. Watch out for the green gremlins walking around. If they get you, you're transported to a random article on my website. Hopefully a good one! The bigger idea here is that we need to start thinking beyond the general paradigms of our internet viewing experience. Who knows what other internet viewing experiences are out there.

** [[https://www.rand.org/pubs/conf_proceedings/CFA4954-1.html][RAND-Helena collab: Building Resilience Against Artificial Intelligence–Enabled Biological Threats]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Public report.\\
...
A report on a series of convenings in DC that I helped [[https://helena.org/][Helena]] put on in collaboration with RAND. These convenings were around AI-Bio safety. The first one was technical-centric and the second one was policy-centric. What I can tell you is that there is a very large gap between what is being said on the internet, and what is being said in person. These convenings were under the [[https://en.wikipedia.org/wiki/Chatham_House_Rule][Chatham House Rule]], so we can only say so much. But have a look at the report.
** [[./dr_provenance_interactive.html][Provenance of CyTOF dimension reduction algorithms]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Interactive html.\\
...
If you want to understand the algorithms used in analyzing data specific to a given field, you need to understand the history of their development. Knowing that Leiden clustering was built on top of Louvain matters, for example. Knowing that UMAP was built after t-SNE matters. Here, I built provenance graph of CyTOF dimensionality reduction/visualization algorithms, from SPADE to UMAP and later. I turned it into an interactive html. We can see that while the field has "collapsed" into UMAP, there are a number of other methods developed after or in parallel to UMAP that could be equally useful or if not useful to your bespoke situation. The bigger picture: this does to the intro section of a paper what SPADE did to the immune system.
** [[https://blog.lamin.ai/intro-to-laminr][An Introduction to LaminR]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Guest blog post.\\
...
One of the longer term issues I've run into in my consulting work is that of coming back to old projects, handing off my work, or receiving work others have handed off to me. There is inevitable confusion as to what was done previously. Lamin solves this problem by tracking every data artifact, in terms of what was done to it when. I think this will become increasingly important, especially when we get to a point where there are AI agents doing work alongside you. LaminR is Lamin's R interface, which I use here to analyze the PBMC 3k dataset, in order to show you what Lamin does.

** [[./cytof_llm_selection_experiment.html][CyTOF clustering algorithms selected at random by LLMs]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
R Markdown.\\
...
If I ask a LLM to select a CyTOF clustering algorithm at random, what do I get? In this experiment, I did that in a 50-iteration loop across a number of models from Anthropic, Google, and xAI's Grok4. The models only chose FlowSOM or PhenoGraph, suggesting a "winner take all" bias in terms of how often the tools are used in the literature. I found that the Antrhopic models prefer FlowSOM, the Google models are mixed, but still lean toward FlowSOM, and Grok4 prefers PhenoGraph. This suggests that similar experiments must be done by anyone who is looking to use AI to assist them in CyTOF analysis pipeliens, to determine where the models might be biased.
** [[./samusik_llm_mishmash.html][Experiment with LLM-generated CyTOF data]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
R Markdown.\\
...
What would happen if I asked a frontier-level LLM to simulate CyTOF data, one cell at a time? Would it "rip" a dataset, number by number? Would it create convincing simulated cells that fit marker distributions, and cell frequency distributions? Would it create a bunch of numbers that make no sense? Here, we tested that by getting Claude Sonnet 4.6 to simulate the Samusik dataset, cell by cell. We provided minimal instructions. We found that for the most part, the cells produced were not in line with the Saumisik dataset. This suggests that either Claude Sonnet is not yet good enough to output simulated Samusik data, or that better prompt engineering is needed to this end.

** [[https://github.com/tjburns08/claude-cytof-seurat-harmony][Experiment with Claude Code for data integration in Seurat]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
GitHub repo.\\
...
Data integration is something that has been well-trodden in both flow cytometry and single-cell RNA sequencing (at the time of writing [2026-02-16 Mon]) due to batch effects that can form. Here, we use Claude Code to ask two questions. 1) Can we place multiple CyTOF files into Seurat? And 2) Can we use Harmony within this Seurat object ot integrate the data? Claude Code figured out a way to do both. There are plenty of limitations in this experiment, especially that of needing to determine whether we lose biological signal in the integration. But this at least is a first step (of many) that can be built off of.
** [[https://github.com/tjburns08/claude-cytof-gating][Experiment with Claude Code for manual gating CyTOF data]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
GitHub Repo.\\
...
Manual gating is an important process for cell subsetting in flow and mass cytometry data. Despite over a decade of innovations in clustering, manual gating has not been replaced. Automated gating has been of interest for a few years now at the time of writing [2026-02-02 Mon]. Here, I tested whether Claude Code could do manual gating on the Samusik mouse bone marrow CyTOF dataset. I found that while lots of work needs to be done, there seems to be a path here, and plenty more things to try. Thus, I present my work in this repo for others to build off of. Hints: try building out an actual interface where individual gates can be adjusted in real time, rather than a script it executes top to bottom. And try getting it to process its own plot images.

** [[https://github.com/tjburns08/cytof_agentic_prompting_experiments][Experiments with Claude Code and Codex for CyTOF analysis]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
GitHub Repo.\\
...
At the time of writing [2026-01-26 Mon], AI agents are becoming much more capable. To this end, I tested them on CyTOF analysis, a domain I know quite well. I did 5 runs for Claude Code and ChatGPT Codex (both regular and xhigh) respectively. The task was to analyze 1 file, the Samusik_01 dataset (from the X-Shift paper). The agents were able to generate code, run the code, and fix issues in real time. The code ran to completion. The output was almost always sensible. The design choices were hit or miss. Future directions include analyzing multi-file datasets (and see if they can find batch effects, and so forth). Overall, this direction looks promising, but needs work. Have a look for further details.
...
:END:
Article.\\
October 9, 2022 - October 13, 2024.
...
** [[./we_choose_to_think.html][We choose to think about stuff]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Article.\\
...
*** [[./louvain_leiden_cluster_stability.html][Louvain versus Leiden cluster stability]]
Markdown.\\
November 17, 2025 - November 19, 2025.

Seurat defaults to Louvain clustering, and Scanpy defaults to the newer and improved Leiden clustering. Here, I try Leiden clustering in Seurat over 20 random seeds, assessing cluster stability by visualizing the cluster centroids on a UMAP as gifs. I find that Leiden clustering in Seurat requires additional parameter turning. In other words, if the settings work for Louvain, they won't necessarily work for Leiden.
*** [[https://github.com/ariannaaalami/interactive_scanpy_pipeline][Scanpy pipeline intuition building app]]
GitHub project.\\
August 28, 2025.

One of the ways that I developed intuition around single-cell and spatial analysis over the years is by changing the settings of a given analysis pipeline and seeing how it changes the output. Here, my intern Arianna and I built an app that allows a user to do that with a simple scanpy analysis of single-cell data. The interface has a couple of "knobs" you can turn, like changing the number of highly variable genes, or the number of PCs, and seeing how that affects the shape of the UMAP downstream, and the placement of pre-annotated cells therein.
...
** Dimension reduction interrogation
*** [[./knn_kfn_sweep_10k.html][UMAP KNN to KFN sweep]]
Web app.\\
July 5, 2026 - July 6, 2026
...
** AI agents & LLMs applied to single-cell
*** [[./cytof_llm_selection_experiment.html][CyTOF clustering algorithms selected at random by LLMs]]
R Markdown.\\
March 13, 2026.
...
Markdown.\\
October 19, 2024 - October 23, 2024.
...
Markdown.\\
September 29, 2024 - October 12, 2024.
...
* AI & language models
#+HTML: <a href="#top">Back to top</a>
A lot of this work is related to natural language embeddings, or taking anything from words to paragraphs and converting them into spatial coordinates that group by context. My most popular work on this is summed up in The Scrolling Problem, which culminated in a TEDx Basel talk in 2023. More recent work here covers LLM behavior probes, AI essays, and agent experiments.
...
*** [[./be_different.html][Be different, now more important than ever]]
Article.\\
November 16, 2025.

AI is starting to produce remixes of popular songs, that sound quite believable. We have seen this across art in general. Here, I argue that our value as humans now is to be the trend setters, the trailblazers, and the forgers of new genres and paradigms, in everything we do. Then, we can let the AI's fill them out. In short, now is a great time to be different.

*** [[./episodic_memory.html][Episodic memory is the new semantic memory]]
Article.\\
June 17, 2023 - January 12, 2025.
...
Article.\\
February 9, 2025 - February 18, 2025.
...
** Semantic embedding: tools, studies, and writeups
*** [[./scrolling_problem.org][The Scrolling Problem]]
Article.\\
July 15, 2022 - February 7, 2023.
...
Article.\\
September 1, 2022 - September 7, 2022.
...
#+HTML: <a href="#top">Back to top</a>
** [[./doomer_good_life.html][If the doomers are right, then be a giver]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Article.\\
August 23, 2025 - May 23, 2026.

If the doomers are right, and we are barreling toward collapse, then how do we live a good life in these conditions? The answer I'm taking is to look back to the Greeks, and specifically the word eudaimonia, or flourishing by means of virtue. I go into the idea of giving more than you take, as one tool to move us toward eudaimonia. This way of doing things is robust to both a good future and a bad future, and leads to both flourishing both at the individual level and community level.
** [[./die_with_zero.html][Die with zero ideas]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
...
:END:
Article.\\
September 14, 2023 - January 20, 2024.
...
* Personal essays
#+HTML: <a href="#top">Back to top</a>
Memoir-style essays drawn from specific moments and experiences in my life.
** [[./kelly_farm_report.html][Remembering the Kelly Farm]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
...
A report on a series of convenings in DC that I helped [[https://helena.org/][Helena]] put on in collaboration with RAND. These convenings were around AI-Bio safety. The first one was technical-centric and the second one was policy-centric. What I can tell you is that there is a very large gap between what is being said on the internet, and what is being said in person. These convenings were under the [[https://en.wikipedia.org/wiki/Chatham_House_Rule][Chatham House Rule]], so we can only say so much. But have a look at the report.
** [[./Krupp-Stanford_E-Newsletter_2025_9MB.pdf][Krupp Stanford Newsletter 2025, featuring my intern]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
Feature.\\
December 5, 2025 - December 10, 2025.

In the summer of 2025, I had a Krupp intern from the Stanford in Berlin program. This was special because I did this same internship when I was in the Stanford in Berlin program in 2007. Here, I got the chance to give back. On page 6 of this pdf, my intern Arianna gives her reflection of how the internship and her summer in general went. I thank the program for giving me the opportunity to mentor Arianna, and I hope for many more Krupp interns to come.
...
An idea I got in the shower. Take a haiku and mutate two letters of a given word each round and watch as the meaning of the poem starts to randomly drift. A haiku is good for this because you can hold the whole thing in your working memory, such that every letter changes the felt sense around the poem in real time. You can do other types of mutations, like whole words or one letter. But two letter worked for this one in partcular: Matsuo Bashō’s "The Old Pond."
** [[./game_mode/game_mode.html][Game mode for viewing my website]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
...
:END:
Game.\\
March 26, 2023 - May 28, 2026.

A standalone browser game where a ship crosses a chasm filled with Conway's Game of Life. Live cells are hazards. Each cleared crossing advances the level, increasing the density and complexity of the living field.
** [[./nose_pick/][Nose Pick]]
:PROPERTIES:
:UNNUMBERED: notoc
:END:
...
This is inspired by a piece of some WarioWare game that I remember playing one summer in college at like 2 in the morning. I built it for my nephew. In case you are wondering how I am using AI.
...
I added additional rules other than GOL to the interface, and the ability to build your own. I realized a few years ago when I was messing with convolutions that you can change the patterns in an interesting way if you toggled what regions of the Moore neighborhood the CA rules actually pay attention to. So you'll see that in the interface too.
