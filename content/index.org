...
A conversation between a hacker and a mathematician that explores the contrast between these worldviews. The mathematician wants to create elegant theories and abstractions that the world fits into. The hacker is more interested in finding and leaning into the things that don't add up. The whitespace.
