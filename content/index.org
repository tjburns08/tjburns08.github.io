...
** [[./minimize_and_sustain.html][Minimization and sustainability for growth: my plan for the recession and beyond]]
My current plan for coming uncertainty we face in the near term due to the recession, and for uncertainty that wil persist beyond the recession (eg. AI disruption). I talk about re-framing my goals as minimizing rather than maximizing something, and about the systems thinking and sustainability based mindset that one sees in subjects like permaculture. Paradoxically, this appraoch has led to both personal and professional growth.

** [[./stick_shift_mindset.html][The stick shift mindset]]
A heuristic I use for life. Pick an endeavor. Complete the analogy: automatic transmission is to your endeavor as manual transmission is to X. If you know how to do X, do it when you can. If you don't know how to do X, then learn it. I give several examples of this in my life, and I conclude by saying that this mindset has improved my life in many ways. 
