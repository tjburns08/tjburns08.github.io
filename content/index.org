...
PhD Thesis.
My dissertation, from the laboratory of Garry P. Nolan at Stanford University School of Medicine. 
...
** [[./read_fcs_by_lines.html][Anatomy of a fcs file]]
Markdown.
I read in a fcs file line by line, rather than using the standard read.FCS from flowCore. We can't read the data directly this way, but we can read in the header and the text.
...
Article.
Occam's razor states that for a given phenomenon, the simplest explanation is the most likely explanation. I explore this with a fun example from my life. I then look at a computational formalization of this, with interesting ties to behavioral science.
