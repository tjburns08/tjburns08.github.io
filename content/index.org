...
* Code
These are primarily R markdowns exploring various topics. I apologize if the one you're reading is a bit messy. Some of these are bits of tinkering that led to interesting results that I simply didn't have the time to finish. Others were pieces I was going to make public but decided not to because of the perfectionist in me (see the coin toss series). I figure that showing unpolished work is better than showing no work. If you have any questions or comments, please feel free to contact me. Anything that gets attention here will trigger me to work on it.
...
Regardless of the reader's intent, I hope above all that the work below will encourage people to really tinker with words, numbers, and data. You can get surprisingly far if you get in the habit of tinkering. 
...
Here, we examine the properties of unfair coins, where the odds of getting heads or tails does not equal 50%. 

** [[./4_random_walk.html][Coin toss series 4: Random walks]]
Here, we show that if we simulate flipping coins, but we keep a record of the number of heads and the number of tails, we end up doing a random walk. From there, we explore the properties of random walks. 

** [[./5_dice_roll.html][Coin toss series 5: Dice rolls]]
Here, we do an abstraction of the coin tosses we have been simulating, by coinsidering dice of three or more faces. We simulate these dice rolls and examine their properties. 
