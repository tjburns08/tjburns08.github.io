#+Title: Learning how to code improved how I think
#+Author: Tyler Burns
...
Taken together, in terms of being a better thinker, it's good to know how things work at least one level under whatever you're doing. I'm not the first to say this by any means. Are you a biologist, at least be familiar with if not competent in chemistry. Are you a python programmer, at least be familiar with if not competent in C. Broadly learn how things work (which is really just another way of saying to look at a thing at a level of analysis above and below wherever you're at).
...
If the second sentence is true, then the first sentence is false, but the first sentence says that the second sentence is true, which would in turn make the second sentence false, but if the second sentence is false then the first sentence is ture. Um...what? Anyway, this is a small but important sliver of the context around Gödel's Incompleteness Theorems, one of the most important contributions to mathematics in human history.
...
-----
\\
Note the concepts. We have emergence, from my section on Conway's Game of Life, and we have function, which is from the section on levels of abstraction. We could also come to the insight that we need to reason about the interaction at the cellular level if we're thinking in terms of the "graph" data structure also talked about earlier.

Now with his mindset in mind, let's move to the brain. In his aforementioned [[https://www.youtube.com/watch?v=P-2P3MSZrBM][podcast with Lex Fridman]], when he's talking about the definition of intelligence, he says:
\\
\\
-----
...
-----
\\
Now you can see than when he's talking about intelligence and whatever else, he is talking about it in a way where he could be talking about humans or he could be talking about computers. Some might be put off by that idea, but in general, we're not talking about replacing your lens of the world with a computational lens. I'm talking about adding computational thinking to your [[https://fs.blog/mental-models/][latticework of mental models]] through which you see the world [3].

What you find is that Joscha will use the computational lens for everything he's looking at. This will include the work of philosophers from hundreds of years ago. For example, in the same podcast, Joscha Bach is later talking about [[https://en.wikipedia.org/wiki/Thomas_Aquinas][Thomas Aquinas]], and he says:
\\
\\
-----
...
So here, he is taking a computational principle: making models and acting on them, and using that to define virtues that people have been debating about for thousands of years. I am not saying that this definition of courage above is completely correct. But what I am saying is that you can get some additional insight on hard problems if you ground your definitions computationally.

Accordingly, the computational lens can bring you down lines of inquiry that you otherwise would not see. I'll note that this computational lens is not just a set of prepared answers for podcasts or whatever else. I have met Joscha in person and he is as authentic to this ways of looking at the world as you're ever going to get (he is also a really cool all-around person).

I listen to Joscha Bach not necessarily because I fully agree with every view he has about how the world works. I listen to him because he embodies the computational lens as good as anyone will be able to do, and I have found this type of computational thinking to be immensely useful in both my work life (bioinformatics, running a business) and my personal life.

* Conclusion: computational thinking has helped my pursuit of wisdom
As I get older, I increasingly value the endless pursuit of wisdom. Cognitive scientist John Vervaeke likes to say that the child is to the adult as the adult is to the sage. I like that framing. Now at least for me, I use computer science along with the scientific method as a base for my thinking and [[./dialectic.html][sensemaking]]. We all know how to do the scientific method, but computer science is both a way to intensively put the scientific method into practice, and way to expand your lexicon to include things that are otherwise hard to put into words. As such, I see computer science as an important lens for modern philosophy, the way Plato saw geometry in his time.
...
[3]
At the end of the day, you're going to have a bunch of lenses from which you view the world. For example, with the COVID-19 pandemic, you had to look at it through many perspectives. The biological lens, in terms of the characteristics of the virus. The economic lens, in terms of perverse incentives that could get in the way of proper management of the pandemic. The sociological lens, in terms of thinking about how policy compliance was falling along political lines.

The computational lens has its place as well, in terms of analyzing the genomic evolution of the virus, making epidemiological models around its spread, and analyzing the "big data" around how the lockdowns were affecting the world economies. I would take this a step further and say that the computational lens is a good way to structure and organize my thoughts and actions around complex matters like this. It provides a rigorous grounding to keep my [[https://www.youtube.com/watch?v=U35T-KzfeLk][ADHD brain]] from going all over the place.
