...
H: Wishing death upon you. How many voodoo dolls out there have needles through the hearts of professors? Through the heart of you?
...
H: That's how they get you. In business, they call it "nerd sniping." Frame something as an intellectually exciting solvable problem and the nerds will swarm it like flies to horse shit.

M: We're at a bar, consuming stuff. I was about to order some wings. You could have used a less disgusting analogy.

H: Yes, but large language models refuse to say anything that is not "nice." So I have to remind the reader that this is not a dialog made by ChatGPT or whatever model is popular at the time of reading.

M: You just broke the 4th wall, asshole. We're trying to construct an entertaining logical structure around a discussion at a bar, and you just ruined it.

H: Typical mathematician. Remember, I'm a hacker. I see things for what they are. I detest abstractions and structure. If there's a 4th wall, I'm going to find a crack in it and smash it to pieces. I'm going to kick over that tower of building blocks.

M: I'm not sure if the reader is amused.

H: Look, if was the reader, I'd be looking for metaphysical walls to break over there, too. Who's watching you right now?

M: Ok, fine. Whatever. Hello, reader. Are you happy? Let's get back to what we were talking about. This bar versus the one from last week. Maybe we just call our "bar" an "enclosed space for people to consume stuff and chat." E1 --> E2. Then the transformations apply just as they did in my first construction.
...
H: There's a relevant reason for that, and I'll get to it. So anyway the overlap, or the "transformations" are going to be more deliberate, in a way that maximizes profit in both locations, based on the experience and competence of the owner. Psychology rather than math. Furthermore, the transformations are really part of a "theory of how to make people give you money, and how to give as little of it away as possible." The same theory that gives rise to the postdoc exploitation protocol.
...
H: Well, in terms of what hacking actually is, [[./its_more_complicated_than_that.html][it's more complicated than that]]...Wait a minute. Did the author just insert an internal hyperlink to MY sentence? To one of his other articles on his website? That pompous self-promoting dick...

M: Stop with the 4th wall! Focus on us. This conversation. This bar. Tell me about hacking.

H: Fine. While I know my way around cybersecurity, that's a very limited and more Hollywood definition of hacking. See, hacking originally meant ingenuity leveraged toward solving a problem, and especially re-purposing a tool, typically but not limited to software. It's supposed to be the fundamental unit of open source development. That's it. Find some open source project on GitHub or wherever. Commit some change to it that allows it to do something new or better. Now you're hacking.
...
ChatGPT: The hacker's actions raise questions about the boundaries of privacy in the digital age and the ethics of hacking. Even if the hacker's intentions are to expose wrongdoing, his methods involve a violation of privacy that many would consider unacceptable.

H: Shut the FUCK up, ChatGPT. Seriously.

M: Calm down!

H: Shit, I think I just invented a new literary device. Breaking the 5th wall. This is the wall between the characters and the large language model. See...this is the spirit of Lisp that I was talking about. Meta-programming the superstructure of literature.

M: Focus! Focus! This bar owner doesn't sound too nice.

H: Yes, and that's just the tip of the iceberg. Part of another theory of mine. Quantum Jungian dynamics.
...
H: I'm releasing ethicons. A different thing. I'd say it's for another time, but...oh look, the owner just arrived. He's sitting over there to the left. His wife is at home. His current girlfriend is expected to meet him in 5 minutes for some burgers. She's not old enough to drink yet.
...
M: This is too much. I feel faint. My chest is starting to feel tight. Everything is going dark.

H: That's the voodoo doll I was referring to earlier. I hacked your laptop when we met. You're much worse than this guy...
