...
# Run the site graph builder (writes public/website_internal_link_graph.html).
# Must run AFTER build_site.el so it scans the freshly-published HTML pages.
cd "$original_dir/../website_graph_view" || exit
